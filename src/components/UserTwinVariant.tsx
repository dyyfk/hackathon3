      ...
      <main className="min-h-screen bg-[#fbfaf8]">
        ...
        <section className="border-b border-stone-200 bg-white">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
              ...
              <div>
                ...
                <p className="mt-4 max-w-2xl text-lg leading-8 text-stone-600">
                  {improved
                    ...
                    : "A baseline page where key booking signals appear later in the task."}
                </p>
              </div>
            ...
            <form
              onSubmit={runSearch}
              className="mt-8 grid gap-3 rounded-2xl border border-stone-200 bg-white p-3 shadow-xl shadow-stone-900/10 md:grid-cols-[1fr_auto_auto]"
            >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-stone-200 bg-stone-50 px-5 py-3 text-sm font-semibold text-stone-700"
              >
      ...
      {checkoutOpen ? (
        ...
        >
          ...
          <div data-testid="checkout-summary" className="mt-4 space-y-3">
            <SummaryLine
              label="Dates"
              value={`${state.checkin} to ${state.checkout}`}
            />
            ...
            <div
              data-testid="cancellation-policy"
              className="flex items-center justify-between rounded-xl bg-white p-3 text-sm text-stone-700"
            >
              <span>Cancellation</span>
              <span>{listing.cancellationPolicy}</span>
            </div>
